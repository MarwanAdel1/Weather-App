package com.example.weather.home_maps_screen.view
...
import com.example.weather.databinding.ActivityHomeMapsBinding
import com.example.weather.home_maps_screen.viewmodel.HomeMapsViewModel
import com.example.weather.home_maps_screen.viewmodel.HomeMapsViewModelFactory
...
class HomeMapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var homeMapsViewModelFactory: HomeMapsViewModelFactory
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setLocation = binding.setLocationBt


        homeMapsViewModelFactory = HomeMapsViewModelFactory(
            this
        )

        homeMapsViewModel =
            ViewModelProvider(this, homeMapsViewModelFactory)[HomeMapsViewModel::class.java]
    }
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        setLocation.setOnClickListener {
            homeMapsViewModel.saveLocation(marker!!.position)
            finish()
        }
    }
